...
export default function AppShell({ children }: PropsWithChildren) {
  ...
  const tab = location.pathname.startsWith('/movements') ? '/movements' : '/'
        ...
        <Toolbar sx={{ gap: 2 }}>
          <Box sx={{ flexGrow: 1, minWidth: 0 }}>
            ...
            <Typography variant="caption" color="text.secondary" sx={{ display: 'block' }} noWrap>
              Modern inventory dashboard • CRUD + movement history
            </Typography>
          </Box>
          ...
          >
            ...
            <Tab label="Movements" value="/movements" component={RouterLink} to="/movements" />
          </Tabs>
        </Toolbar>
      </AppBar>
